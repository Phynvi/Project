...
import com.overload.net.packet.impl.*;
...
public class PacketConstants {
	...
	private static final int TELEPORT_OPCODE = 183;
	...
	public static final int TELEPORT_REQUEST_PACKET = 160;
    ...
    public static final int
            ENTER_AMOUNT_OPCODE = 208,
            ENTER_SYNTAX_OPCODE = 60;
	...
	public static final int
            ...
            FOURTH_CLICK_NPC_OPCODE = 18;

	public static final int
            FIRST_ITEM_ACTION_OPCODE = 122,
            SECOND_ITEM_ACTION_OPCODE = 75,
	...
	public static final int
            ...
            ITEM_ON_ITEM = 53,
            ITEM_ON_OBJECT = 192,
            ITEM_ON_GROUND_ITEM = 109,
			ITEM_ON_PLAYER = 14;

	static {
		for (int i = 0; i < PACKETS.length; i++) {
			PACKETS[i] = new UnusedPacketListener();
		}
