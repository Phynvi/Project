...
import com.overload.net.service.ForumService;
...
public class GameConstants {
    ...
    public static final String FORUM_DB_URL = "jdbc:mysql://overloadps.com:3306/overloa1_overlord_oslegac3_dbzosl8r";

    /** This is used for mySQL to authenticate username and passwords from the forum.  */
    public static final String FORUM_DB_USER = "overloa1_forum";

    /** This is used for mySQL to authenticate username and passwords from the forum. */
    public static final String FORUM_DB_PASS = "1]y(AoncdT5f";

	/**
	 * The directory of the clipping files.
	 */
	public static final String CLIPPING_DIRECTORY = "./data/clipping/";
    public static final boolean MAP_IS_GZ = false;
	 ...
	 * cycle.
	 */
	public static final int QUEUED_LOOP_THRESHOLD = 150;

	/**
	 * Edgeville Location
	 */
	public static final Position EDGEVILLE = new Position(3086, 3496, 0);
	 ...
	 */
	public static final int TAB_INTERFACES[] = { 2423, 3917, -1, 3213, 1644, 5608, -1, 37128, 5065, 5715, 2449,
			42500, 147, 32000 };
