...
public class Boundary {
	...
	public static boolean isIn(Player player, Boundary boundaries) {
		if (boundaries.height >= 0) {
			if (player.getRegionHeight() != boundaries.height) {
				return false;
			}
		}
    ...
    public static boolean isInBounds(Position pos, Boundary boundaries) {
        return pos.getX() >= boundaries.minX && pos.getX() <= boundaries.highX && pos.getY() >= boundaries.minY && pos.getY() <= boundaries.highY;
    }
	...
	public static final Boundary LUMBRIDGE_BOUNDARY = new Boundary(3142, 3139, 3265, 3306);
	...
	//public static final Boundary WILDERNESS = new Boundary(2941, 3524, 3392, 3968); // (2941, 3524, 3392, 3968);
//public static final Boundary WILDERNESS = new Boundary(1486, 1444, 3767, 3730);
	...
	public static final Boundary _BOUNDARY = new Boundary(2644, 3288, 2678, 3323);
	public static final Boundary[] ROOFTOP_COURSES = { SEERS_BOUNDARY, VARROCK_BOUNDARY, ARDOUGNE_BOUNDARY };
	public static final Boundary DONATOR_ZONE = new Boundary(1610, 3723, 1725, 3775);
