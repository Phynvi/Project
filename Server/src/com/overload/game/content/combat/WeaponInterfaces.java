...
public final class WeaponInterfaces {
    ...
    public enum WeaponInterface {
        ABYSSAL_BLUDGEON(4705, 4708, 4,
        		new FightType[]{
	                FightType.ABYSSAL_BLUDGEON_CHOP,
	                FightType.ABYSSAL_BLUDGEON_SLASH,
	                FightType.ABYSSAL_BLUDGEON_SMASH,
	                FightType.ABYSSAL_BLUDGEON_BLOCK
	            },
        		7699,
        		7711),
        ...
        public static WeaponInterface containsPartial(String itemName) {
            itemName = itemName.replaceAll(" ", "_");
            for (WeaponInterface inter : WeaponInterface.values()) {
                if (itemName.equalsIgnoreCase(inter.name()))
                    return inter;
            }
            for (WeaponInterface inter : WeaponInterface.values()) {
                if (itemName.toLowerCase().contains(inter.name().toLowerCase()))
                    return inter;
            }
            return UNARMED;
        }
    ...
    public static void assign(Player player) {
        ...
        if (equippedWeapon.getId() > 0) {
            //if (equippedWeapon.getDefinition().getWeaponInterface() != null) {
                weapon = WeaponInterface.containsPartial(equippedWeapon.getDefinition().getName());//equippedWeapon.getDefinition().getWeaponInterface();
            //}
        }
    ...
    /*	for (FightType type : weapon.getFightType()) {
        ...
        for (FightType type : weapon.getFightType()) {
            if (type.getStyle() == FightStyle.AGGRESSIVE) {
                player.getCombat().setFightType(type);
                player.getPacketSender().sendConfigByte(player.getCombat().getFightType().getParentId(), player.getCombat().getFightType().getChildId());
                return;
            }
        }
    ...
    public static boolean changeCombatSettings(Player player, int button) {
        switch (button) {
            case 1772: // shortbow & longbow
                if (player.getCombat().getWeapon() == WeaponInterface.SHORTBOW) {
                    player.getCombat().setFightType(FightType.SHORTBOW_ACCURATE);
                        ...
                        || player.getCombat().getWeapon() == WeaponInterface.DARK_BOW) {
                ...
                } else if (player.getCombat().getWeapon() == WeaponInterface.KARILS_CROSSBOW) {
                    player.getCombat().setFightType(FightType.KARILS_CROSSBOW_ACCURATE);
                }
                return true;
            case 1771:
                if (player.getCombat().getWeapon() == WeaponInterface.SHORTBOW) {
                    ...
                    player.getCombat().setFightType(FightType.KARILS_CROSSBOW_RAPID);
                }
                return true;
            case 1770:
                if (player.getCombat().getWeapon() == WeaponInterface.SHORTBOW) {
                    ...
                    player.getCombat().setFightType(FightType.KARILS_CROSSBOW_LONGRANGE);
                }
                return true;
            case 2282: // dagger & sword
                ...
                } else if (player.getCombat().getWeapon() == WeaponInterface.DRAGON_DAGGER) {
                    player.getCombat().setFightType(FightType.DRAGON_DAGGER_STAB);
            ...
            case 2285:
                if (player.getCombat().getWeapon() == WeaponInterface.DAGGER) {
                    ...
                    player.getCombat().setFightType(FightType.DRAGON_DAGGER_LUNGE);
                } else if (player.getCombat().getWeapon() == WeaponInterface.SWORD) {
            ...
            case 2284:
                if (player.getCombat().getWeapon() == WeaponInterface.DAGGER) {
                    ...
                    player.getCombat().setFightType(FightType.DRAGON_DAGGER_SLASH);
                } else if (player.getCombat().getWeapon() == WeaponInterface.SWORD) {
            ...
            case 2283:
                if (player.getCombat().getWeapon() == WeaponInterface.DAGGER) {
                    ...
                    player.getCombat().setFightType(FightType.DRAGON_DAGGER_BLOCK);
                } else if (player.getCombat().getWeapon() == WeaponInterface.SWORD) {
            ...
            case 2430:
                ...
                return true;
            case 3802: // mace
                if (player.getCombat().getWeapon() == WeaponInterface.VERACS_FLAIL) {
                    player.getCombat().setFightType(FightType.VERACS_FLAIL_POUND);
                } else {
            ...
            case 3805:
                if (player.getCombat().getWeapon() == WeaponInterface.VERACS_FLAIL) {
                    player.getCombat().setFightType(FightType.VERACS_FLAIL_PUMMEL);
                } else {
            ...
            case 3804:
                if (player.getCombat().getWeapon() == WeaponInterface.VERACS_FLAIL) {
                    player.getCombat().setFightType(FightType.VERACS_FLAIL_SPIKE);
                } else {
            ...
            case 3803:
                if (player.getCombat().getWeapon() == WeaponInterface.VERACS_FLAIL) {
                    player.getCombat().setFightType(FightType.VERACS_FLAIL_BLOCK);
                } else {
            ...
            case 4454: // knife, thrownaxe, dart & javelin
                ...
                } else if (player.getCombat().getWeapon() == WeaponInterface.OBBY_RINGS) {
                    player.getCombat().setFightType(FightType.OBBY_RING_ACCURATE);
            ...
            case 4453:
                if (player.getCombat().getWeapon() == WeaponInterface.KNIFE) {
                    ...
                    player.getCombat().setFightType(FightType.OBBY_RING_RAPID);
                } else if (player.getCombat().getWeapon() == WeaponInterface.THROWNAXE) {
            ...
            case 4452:
                if (player.getCombat().getWeapon() == WeaponInterface.KNIFE) {
                    ...
                    player.getCombat().setFightType(FightType.OBBY_RING_LONGRANGE);
                } else if (player.getCombat().getWeapon() == WeaponInterface.THROWNAXE) {
            ...
            case 433: // warhammer
                ...
                } else if (player.getCombat().getWeapon() == WeaponInterface.MAUL) {
                    player.getCombat().setFightType(FightType.MAUL_POUND);
                } else if (player.getCombat().getWeapon() == WeaponInterface.WARHAMMER) {
                    player.getCombat().setFightType(FightType.WARHAMMER_POUND);
                } else if (player.getCombat().getWeapon() == WeaponInterface.ELDER_MAUL) {
                    player.getCombat().setFightType(FightType.ELDER_MAUL_POUND);
                }
                return true;
            case 432:
                if (player.getCombat().getWeapon() == WeaponInterface.GRANITE_MAUL) {
                    ...
                    player.getCombat().setFightType(FightType.MAUL_PUMMEL);
                } else if (player.getCombat().getWeapon() == WeaponInterface.WARHAMMER) {
                    player.getCombat().setFightType(FightType.WARHAMMER_PUMMEL);
                } else if (player.getCombat().getWeapon() == WeaponInterface.ELDER_MAUL) {
                    player.getCombat().setFightType(FightType.ELDER_MAUL_PUMMEL);
                }
                return true;
            case 431:
                if (player.getCombat().getWeapon() == WeaponInterface.GRANITE_MAUL) {
                    ...
                    player.getCombat().setFightType(FightType.MAUL_BLOCK);
                } else if (player.getCombat().getWeapon() == WeaponInterface.WARHAMMER) {
                    player.getCombat().setFightType(FightType.WARHAMMER_BLOCK);
                } else if (player.getCombat().getWeapon() == WeaponInterface.ELDER_MAUL) {
                    player.getCombat().setFightType(FightType.ELDER_MAUL_BLOCK);
                }
                return true;
            case 782: // scythe
            ...
            case 1704: // battle axe
                if (player.getCombat().getWeapon() == WeaponInterface.GREATAXE) {
                    player.getCombat().setFightType(FightType.GREATAXE_CHOP);
                } else {
            ...
            case 1707:
                if (player.getCombat().getWeapon() == WeaponInterface.GREATAXE) {
                    player.getCombat().setFightType(FightType.GREATAXE_HACK);
                } else {
            ...
            case 1706:
                if (player.getCombat().getWeapon() == WeaponInterface.GREATAXE) {
                    player.getCombat().setFightType(FightType.GREATAXE_SMASH);
                } else {
            ...
            case 1705:
                if (player.getCombat().getWeapon() == WeaponInterface.GREATAXE) {
                    player.getCombat().setFightType(FightType.GREATAXE_BLOCK);
                } else {
