...
public enum CombatSpells  {
    ...
    CONFUSE(new CombatEffectSpell() {
        ...
        @Override
        public Optional<Projectile> castProjectile(Character cast, Character castOn) {
            return Optional.of(new Projectile(cast, castOn, 103, 0, 20, 43, 31, 0));
        }
    ...
    WEAKEN(new CombatEffectSpell() {
        ...
        @Override
        public Optional<Projectile> castProjectile(Character cast, Character castOn) {
            return Optional.of(new Projectile(cast, castOn, 106, 0, 20, 43, 31, 0));
        }
    ...
    CURSE(new CombatEffectSpell() {
        ...
        @Override
        public Optional<Projectile> castProjectile(Character cast, Character castOn) {
            return Optional.of(new Projectile(cast, castOn, 109, 0, 20, 43, 31, 0));
        }
    ...
    CRUMBLE_UNDEAD(new CombatNormalSpell() {
        ...
        public void finishCast(Character cast, Character castOn, boolean accurate, int damage) {
            crumble(cast.getAsPlayer(), castOn.getAsNpc());
        }
    ...
    TRIDENT_OF_SEAS(new CombatNormalSpell() {
        @Override
        public Optional<Animation> castAnimation() {
            return Optional.of(new Animation(791));
        }

        @Override
        public Optional<Projectile> castProjectile(Character cast, Character castOn) {
            return Optional.of(new Projectile(cast, castOn, 1252, 50, 70, 30, 30, 2));
        }
        ...
        @Override
        public Optional<Graphic> startGraphic() {
            return Optional.of(new Graphic(1251, 3));
        }
        ...
        @Override
        public Optional<Item[]> equipmentRequired(Player player) {
            return Optional.of(new Item[] { new Item(11907) });
        }

        @Override
        public Optional<Item[]> itemsRequired(Player player) {
            return Optional.of(new Item[] { new Item(560, 1), new Item(554, 5), new Item(562, 1), new Item(995, 10) });
        }
    ...
    VULNERABILITY(new CombatEffectSpell() {
        ...
        @Override
        public Optional<Projectile> castProjectile(Character cast, Character castOn) {
            return Optional.of(new Projectile(cast, castOn, 168, 0, 20, 43, 31, 0));
        }
    ...
    ENFEEBLE(new CombatEffectSpell() {
        ...
        @Override
        public Optional<Projectile> castProjectile(Character cast, Character castOn) {
            return Optional.of(new Projectile(cast, castOn, 171, 0, 20, 43, 31, 0));
        }
    ...
    STUN(new CombatEffectSpell() {
        ...
        @Override
        public Optional<Projectile> castProjectile(Character cast, Character castOn) {
            return Optional.of(new Projectile(cast, castOn, 174, 0, 20, 43, 31, 0));
        }
    ...
    TELEBLOCK(new CombatEffectSpell() {
        ...
        @Override
        public Optional<Projectile> castProjectile(Character cast, Character castOn) {
            return Optional.of(new Projectile(cast, castOn, 344, 0, 20, 43, 31, 0));
        }
    ...
    TRIDENT_OF_THE_SEAS(new CombatNormalSpell() {
         ...
         @Override
         public Optional<Projectile> castProjectile(Character cast, Character castOn) {
             return Optional.of(new Projectile(cast, castOn, 1252, 0, 20, 43, 31, 0));
         }
    ...
    TRIDENT_OF_THE_SWAMP(new CombatNormalSpell() {
        ...
        @Override
        public Optional<Projectile> castProjectile(Character cast, Character castOn) {
            return Optional.of(new Projectile(cast, castOn, 1040, 0, 20, 43, 31, 0));
        }
    ...
    public static boolean crumble(Player player, NPC npc) {
        ...
        switch (npc.getId()) {
            case 8063://Zombified Minion Shitter
                npc.getCombat().getHitQueue().addPendingDamage(new HitDamage(npc.getHitpoints(), HitMask.RED));
                return true;
            default:
                return false;
