...
public class RangedData {
    ...
    public enum Ammunition {
        ...
        BRONZE_THROWNAXE(800, new Graphic(43, GraphicHeight.HIGH), 36 , 3),
        IRON_THROWNAXE(801,  new Graphic(42, GraphicHeight.HIGH), 35, 3),
		STEEL_THROWNAXE(802,  new Graphic(44, GraphicHeight.HIGH), 37, 7),
		MITHRIL_THROWNAXE(803,  new Graphic(45, GraphicHeight.HIGH), 38, 10),
		ADAMANT_THROWNAXE(804,  new Graphic(46, GraphicHeight.HIGH), 39, 14),
		RUNE_THROWNAXE(805,  new Graphic(48, GraphicHeight.HIGH), 41, 24),
