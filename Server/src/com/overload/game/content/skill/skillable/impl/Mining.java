...
public class Mining extends DefaultSkillable {
    ...
    public void finishedCycle(Player player) {
        ...
        TaskManager.submit(new TimedObjectReplacementTask(rockObject, new GameObject(2704, rockObject.getPosition()), rock.getRespawnTimer()));
    }

    @Override
    public int cyclesRequired(Player player) {
        int cycles = rock.getCycles() + Misc.getRandom(5);
    ...
    public  enum Rock {
        ...
        SILVER(new int[]{2100, 2101, 29226, 29225}, 20, 40, 442, 14, 7),
