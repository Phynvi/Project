...
import com.overload.game.content.skill.skillable.impl.Mining;
import com.overload.game.content.skill.runecrafting.Runecrafting;
import com.overload.game.content.skill.skillable.impl.Woodcutting;
import com.overload.game.content.skill.skillable.impl.Mining.Rock;
import com.overload.game.content.skill.skillable.impl.Woodcutting.Tree;
...
import com.overload.game.model.syntax.impl.SetLevel;
...
public class SkillManager {
	...
	public SkillManager addExperience(Skill skill, int experience, boolean multipliers) {
		// Multipliers...
		if (multipliers) {
			experience *= Multipliers.valueOf(skill.name()).getMultiplier();
		}
	...
	public int getCombatLevel() {
		if (player.getRights().isOrInherits(Right.GAME_DEVELOPER) && player.isInvulnerable()) {
			return 255;
		}
	...
	public static void sendInterface(Player player, int itemId) {
		player.getPacketSender().sendChatboxInterface(4429);
		player.getPacketSender().sendItemOnInterface(1746, itemId, 1);
		player.getPacketSender().sendString("\\n\\n\\n\\n\\n" + new Item(itemId).getDefinition().getName(), 2799);
	}
	...
	public boolean startSkillable(GameObject object) {
		// Check woodcutting..
		Optional<Tree> tree = Tree.forObjectId(object.getDefinition().getName());
		if (tree.isPresent()) {
