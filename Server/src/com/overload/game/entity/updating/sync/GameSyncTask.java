package com.overload.game.entity.updating.sync;
...
public abstract class GameSyncTask {
     ...
     *
     * @param type       the type of character using this synchronization task.
     * @param concurrent the flag that determines if this should be executed
     *                   concurrently.
     */
     ...
     *
     * @param index the index about to be used.
     ...
     *
     * @param index the character index the synchronization is being done for.
     */
