 ...
 * re
 * moving ignored players who will not be able to message us or see us online.
 *
...
public class PlayerRelations {
        ...
        if (friendList.contains(username)) {
            ...
            if (friend.isPresent()) {
                ...
                if (player.getInterfaceId() == 45000) {
                    ClanChatManager.sendClanSettingsInterface(player, player.getCurrentClanChat());
                }
            }
        }
    }
     ...
     */
    public void message(Player friend, String message) {
        ...
        friend.getPacketSender().sendPrivateMessage(player, message);
        HandleLogs.executeLog(player, " [ " + friend.getLongUsername() + " ] " + message, HandleLogs.LogType.PRIVATEMESSAGE);
    }
