package com.overload.game.model.container;
...
public abstract class ItemContainer {
	...
	public ItemContainer delete(Item[] ingredients) {
		for (Item ingredient : ingredients) {
	        return delete(ingredient, getSlot(ingredient.getId()), true, null);
		}
		return this;
	}
     ...
     * @return
     */
    public String getTotalValue() {// https://www.rune-server.ee/runescape-development/rs2-server/snippets/656858-osrs-pk-fixing-itemcontainer-total-wealth.html
        int k = 0;
     ...
     * @return
     */
    public Long getTotalValueLong() {// https://www.rune-server.ee/runescape-development/rs2-server/snippets/656858-osrs-pk-fixing-itemcontainer-total-wealth.html
        long k = 0;
