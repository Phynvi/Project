...
public class TripleItemCreationMenu extends CreationMenu {
    ...
    public CreationMenu open() {
        ...
        getPlayer().getPacketSender().sendInterfaceModel(8883, firstItem, 200);
