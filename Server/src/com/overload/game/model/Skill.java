...
public enum Skill {
     ...
     */
    private static final ImmutableSet<Skill> ALLOWED_TO_SET_LEVLES = Sets.immutableEnumSet(
    			...
    			SLAYER,FARMING,RUNECRAFTING,CONSTRUCTION,HUNTER
    		);
    ...
    public static final boolean isSuccess(Player p, Skill skill, int levelRequired) {
        double level = p.getSkillManager().getMaxLevel(skill);
