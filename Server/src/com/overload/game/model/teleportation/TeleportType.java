...
public enum TeleportType {
    ...
    LUNAR(4, new Animation(6303, Priority.HIGH), null, new Animation(9013, Priority.HIGH), new Graphic(392, Priority.HIGH), null, null),
    ARCEUUS(5, new Animation(6303, Priority.HIGH), null, Animation.DEFAULT_RESET_ANIMATION, new Graphic(392, Priority.HIGH), null, null),
