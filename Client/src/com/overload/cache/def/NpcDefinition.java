...
public final class NpcDefinition {
    ...
    public static NpcDefinition lookup(int id) {
        ...
        index = (index + 1) % 20;
        NpcDefinition definition = cache[index] = new NpcDefinition();
        ...
        switch (id) {
	    	...
	    	case 1739:
	    		...
	    		definition.modelId = new int[] { 14533, 14527, 14528 };
	    		definition.actions = new String[] { null, "Attack", null, null, null };
	    		break;
	    	case 1740:
	    		definition.name = "Portal";
	    		definition.recolourOriginal = new int[] { -11149, -11033, -10792, -10317, -10333 };
	    		definition.recolourTarget = new int[] { -22293, -22184, -22320, -22330, -22343  };
	    		definition.modelId = new int[] { 14533, 14527, 14528 };
	    		definition.actions = new String[] { null, "Attack", null, null, null };
	    		break;
	    	case 1741:
	    		definition.name = "Portal";
	    		definition.recolourOriginal = new int[] { -11149, -11033, -10792, -10317, -10333 };
	    		definition.recolourTarget = new int[] { 10355, 10471, 10941, 11200, 11187 };
	    		definition.modelId = new int[] { 14533, 14527, 14528 };
	    		definition.actions = new String[] { null, "Attack", null, null, null };
	    		break;
        	case 1742:
        		definition.name = "Portal";
        		definition.recolourTarget = new int[] { -11149, -11033, -10792, -10317, -10333 };
        		definition.recolourOriginal = new int[] { -2125, -2249, -2373, -2490, -2490 };
        		definition.modelId = new int[] { 14533, 14527, 14528 };
        		definition.actions = new String[] { null, "Attack", null, null, null };
        		break;
            //Pets
            ...
            case 995:
                ...
                break;
            case 512:
            	definition.name = "Supplies Trader";
    ...
    public static void dump() {
		List<NpcDefinition> dumped = new ArrayList<>();
    	for (int i = 0; i < TOTAL_NPCS; i++) {
    		Client.instance.drawLoading("Dumping NPC Defs", ((i / TOTAL_NPCS) * 100));
		...
		String json = gson.toJson(dumped);
		
		System.out.println("Total Npcs Dumped: " + dumped.size()); 

		try {  
			FileWriter writer = new FileWriter("./npc-defs.json");  
			writer.write(json);  
			writer.close();  
    ...
    public static void init(FileArchive archive) {
        ...
        System.err.println("[Overload] Loaded: " + size + " mobs");
