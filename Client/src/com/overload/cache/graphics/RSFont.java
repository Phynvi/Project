...
public class RSFont extends Rasterizer2D {
    ...
    public void drawCenteredString(String string, int drawX, int drawY, int color, int shadow,int transparency) {
        if (string != null) {
            setColorAndShadow(color, shadow);
            setTrans(shadow,color,transparency);
                    ...
                    if (effectString.equals(startEffect)) {
                        ...
                        if (effectString.startsWith(startImage)) {
                            try {
                                ...
                                int iconModY = chatImageId.myHeight;

                                chatImageId.drawAdvancedSprite(drawX, (drawY + baseCharacterHeight - iconModY) + 1);
