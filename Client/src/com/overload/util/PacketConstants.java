...
public final class PacketConstants {
    ...
    public static final int							   FADE_TO_BLACK = 5;
    ...
    public static final int 						   DESIGN_SCREEN = 102;
    ...
    public static final int 				   NEXT_OR_PREVIOUS_SONG = 120;
    ...
    public static final int 				 	  UPDATE_POISON_TYPE = 184;
    public static final int 							BUTTON_CLICK = 185;
    public static final int 		   SHOW_PLAYER_HEAD_ON_INTERFACE = 186;
    public static final int 						 SEND_ENTER_NAME = 187;
    public static final int 			     			SAVE_ACCOUNT = 188;
    ...
    public static final int 							  ADD_IGNORE = 213;
    ...
    public static final int 		 SEND_WALKABLE_CHATBOX_INTERFACE = 220;
    ...
    public static final int 							 MOUSE_CLICK = 242;
