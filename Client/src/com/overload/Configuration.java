...
public final class Configuration {
    ...
    public static final String CLIENT_NAME = "Overload";
    public static final int npcBits = 14;
    public static boolean clientDebug = true;
    
    private static boolean live = true;
    public static String FILE_SERVER_ADDRESS = live ? "185.218.235.15" : "localhost";
    public static String SERVER_ADDRESS = live ? "185.218.235.15" : "localhost";
