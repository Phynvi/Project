...
import com.overload.ScreenMode;
...
public class SkillOrbs {
    ...
    public static void process() {
        ...
        // Positioning of orbs
        int y = 12;
        int x = Client.frameMode == ScreenMode.FIXED ? (int) (Client.frameWidth / 3.1) - (totalOrbs * 30) : (Client.frameWidth / 2) - (totalOrbs * 30);
        ...
        for (SkillOrb orb : orbs) {
            if (draw(orb)) {
                ...
                int xLimit = Client.frameMode == ScreenMode.FIXED ? 300 : Client.frameWidth - 203;
