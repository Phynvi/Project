package com.overload.entity.model;

import com.overload.cache.anim.Frame;
import com.overload.cache.anim.FrameBase;
...
import com.overload.net.requester.Provider;
...
//	}
	...
	public void applyAnimationFrame(int frame, int nextFrame, int end, int cycle) {
		if (!GameGraphics.TWEENING.toggled()) {
