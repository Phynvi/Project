...
public final class Player extends Mob {
    ...
    public void updateAppearance(Buffer buffer) {
        ...
        for (int bodyPart = 0; bodyPart < 12; bodyPart++) {
        	...
        	Client.myHeadAndJaw[0] = equipment[bodyPart]-256;
			if(bodyPart == 11)
				Client.myHeadAndJaw[1] = equipment[bodyPart]-256;
            if (equipment[bodyPart] >= 512 && equipment[bodyPart] - 512 < ItemDefinition.TOTAL_ITEMS) {
    ...
    public Model getAnimatedModel() {
        if (npcDefinition != null) {
            ...
            if (super.emoteAnimation >= 0 && super.animationDelay == 0) {
                ...
                if (GameGraphics.TWEENING.toggled() && super.nextAnimationFrame != -1) {
                ...
                if (GameGraphics.TWEENING.toggled() && super.nextIdleAnimationFrame != -1) {
